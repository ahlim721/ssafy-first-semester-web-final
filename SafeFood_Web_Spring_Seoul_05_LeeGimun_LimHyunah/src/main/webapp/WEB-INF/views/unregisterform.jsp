...
<body>
	<div class="login">
		...
		<form method="POST" action="unregisterProcess.safefood">
			<h2 style="font-weight: bold;">회원탈퇴</h2>
			<p>
				&nbsp;&nbsp;ID : <input type="text" name="id" value="${sessionId}" readonly="readonly"/>
			</p>
			<p>
				PW : <input type="password" name="pass" />
			</p>
			<div id="center">
				<input type="submit" class="styled" value="회원탈퇴">
			</div>
		</form>
	</div>
</body>
