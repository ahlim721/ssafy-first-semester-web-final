					...
					<li>
						<div class="container item-info">
							...
							<div class="container col-md-10 col-sm-10 col-lg-10">
								...
								<p>${f.maker}</p>
								<p>${f.material}</p>
								<a href="#" class="btn col-md-4 col-sm-4 col-lg-4">수정</a> 
								<a href="delFoodProcess.safefood?id=${sessionId}&code=${f.code}"
									class="btn col-md-4 col-sm-4 col-lg-4 col-md-offset-1 col-sm-offset-1 col-lg-offset-1">삭제</a>
							</div>
						</div>
					</li>
				</c:forEach>
