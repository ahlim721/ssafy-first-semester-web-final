...
<script type="text/javascript">
	function go() {
		location.replace('myinfomodifyresult.safefood');
	}
	function main() {
...
<body>
	<div id="container">
		<form method="POST" action="modifyProcess.safefood?id=${m.id }">
			<center>
				<h2 style="font-weight: bold;">내 정보 수정</h2>
			</center>
			...
			<table cellspacing="10">
				...
				<tr>
					...
					<td><input type="password" value="${m.pass}"
						name="pass" /></td>
				</tr>
				<tr>
					<td style="font-weight: bold;">이름</td>
					<td><input type="text" value="${m.name}" name="name" /></td>
				</tr>
				<tr>
					<td style="font-weight: bold;">주소</td>
					<td><input type="text" value="${m.address}" size="70"
						name="address" /></td>
				</tr>
				<tr>
			...
			<center>
				<input type="submit" class="styled" value="수정완료" />
