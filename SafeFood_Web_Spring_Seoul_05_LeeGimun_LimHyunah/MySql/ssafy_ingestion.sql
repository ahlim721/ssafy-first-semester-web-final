...
CREATE TABLE `ingestion` (
  ...
  KEY `fk_ing_code` (`code`),
  CONSTRAINT `fk_ing_code` FOREIGN KEY (`code`) REFERENCES `food` (`code`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_ing_mid` FOREIGN KEY (`mid`) REFERENCES `member` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
